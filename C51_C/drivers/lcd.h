...
#define __delay_ms__(x) os_wait(K_TMO, x , 0)

#define __delay_us__(x)  __delay_loop_((long) x)
//#define __delay_us__(x) os_wait(K_TMO, LCD_REFRESH_DELAY, 0)
